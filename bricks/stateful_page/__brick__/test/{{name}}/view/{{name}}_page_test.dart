...
class Mock{{# pascalCase}}{{name}}{{/ pascalCase}}Bloc extends MockBloc<{{# pascalCase}}{{name}}{{/ pascalCase}}Event, {{# pascalCase}}{{name}}{{/ pascalCase}}State> implements {{# pascalCase}}{{name}}{{/ pascalCase}}Bloc {}
